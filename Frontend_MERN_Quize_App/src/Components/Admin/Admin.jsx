        ...
        <div className="w-7/12 ">
          ...
          <div className=" ml-32 leading-normal">
            <p className="text-lg text-black-100 leading-loose">
              A Full Stack Web Developer 🚀 from kurukshetra, India, currently 💻 I'm
              doing my Full Stack Development from LNM Institute of Information Technology, Jaipur. I am passionate
