...
export const deleteUserByAdmin = (payload) => (dispatch) => {
  axios
    .delete(`http://localhost:3000/${payload}`)
    .then((response) => {
...
export const postQuizObj = (obj) => (dispatch) => {
  axios
    .post("http://localhost:3000/admin", obj)
    .then((res) => {
...
export const getQuiz = (params) => (dispatch) => {
  axios
    .get(`http://localhost:3000/quiz/${params.id}`)
    .then((res) => {
...
export const postQuizResult = (obj) => (dispatch) => {
  ...
  axios
    .post(`http://localhost:3000/userResult/${userId}`, obj)
    .then((res) => {
